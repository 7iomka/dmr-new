...
<nav class="lg:hidden fixed bottom-0 left-0 right-0 h-15 bg-card border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-around z-[100]">
  ...
  <?php else: ?>
    <a href="<?= htmlspecialchars(demoAuthUrl('1'), ENT_QUOTES, 'UTF-8') ?>" class="flex flex-col items-center space-y-1 text-zinc-400 outline-none transition-colors">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="m16 17 5-5-5-5"></path>
        <path d="M21 12H9"></path>
        <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
      </svg>
      <span class="text-[9px] font-bold uppercase">Войти</span>
    </a>
  <?php endif; ?>
</nav>
