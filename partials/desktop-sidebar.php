...
<aside id="sidebar"
	...
	<div class="h-20 px-2 flex items-center justify-between">
		...
		<button onclick="toggleSidebar()"
			class="js-desktop-sidebar-toggle hidden lg:flex w-9 h-9 items-center justify-center text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
			<i class="w-5 h-5" data-lucide="chevrons-left"></i>
		</button>
	</div>
