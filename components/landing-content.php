...
.dm-landing .hero { min-height: auto; padding-top: 24px; }
  .dm-landing *, .dm-landing *::before, .dm-landing *::after { box-sizing: border-box; margin: 0; padding: 0; }

  .dm-landing { scroll-behavior: smooth; }
  ...
  /* ── Scrollbar ── */
  .dm-landing ::-webkit-scrollbar { width: 4px; }
  .dm-landing ::-webkit-scrollbar-track { background: var(--bg2); }
  .dm-landing ::-webkit-scrollbar-thumb { background: var(--scroll-thumb); border-radius: 4px; }

  /* ── Utilities ── */
  .dm-landing .container { width: 100%; max-width: 80rem; margin: 0 auto; padding: 0 16px; }
  @media(min-width:1024px){ .dm-landing .container { padding: 0 40px; } }
  .dm-landing .section { padding: 48px 0; }
  .dm-landing .section-sm { padding: 40px 0; }
  @media(min-width:1024px){
    .dm-landing .section { padding: 64px 0; }
    .dm-landing .section-sm { padding: 56px 0; }
  }
  .dm-landing .tag {
  ...
  .dm-landing .tag svg { width: 12px; height: 12px; }

  .dm-landing h1,.dm-landing h2,.dm-landing h3,.dm-landing h4 { font-family: var(--ff-head); line-height: 1.1; }
  .dm-landing h1 { font-size: clamp(2.2rem,4.8vw,3.8rem); font-weight: 800; }
  .dm-landing h2 { font-size: clamp(2rem,4vw,3.2rem); font-weight: 800; }
  .dm-landing h3 { font-size: clamp(1.1rem,2.5vw,1.5rem); font-weight: 700; }
  ...
  .dm-landing nav { display: flex; align-items: center; gap: 4px; }
  .dm-landing nav a {
    color: var(--muted); font-size: 13px; font-weight: 500;
    padding: 6px 14px; border-radius: 6px; text-decoration: none;
    transition: color .15s, background .15s;
  }
  .dm-landing nav a:hover { color: var(--text); background: var(--surface-2); }
  ...
  .hero {
    ...
    position: relative; overflow: hidden; padding-top: 16px;
  }
  .hero-bg {
  ...
  .hero-grid {
    position: absolute; inset: 0; opacity: var(--grid-opacity); z-index: 0;
    background-image:
  ...
  .hero-inner {
    ...
    align-items: center; width: 100%; max-width: 80rem; margin: 0 auto; padding: 80px 16px;
  }
  .hero-eyebrow { display: flex; align-items: center; gap: 12px; margin-bottom: 20px; }
  @media(min-width:1024px){ .hero-inner { padding: 80px 40px; } }
  .live-dot {
  ...
  .dm-landing .hero h1 { font-size: clamp(2rem, 4.2vw, 3.35rem); }
  .dm-landing .hero h1 { margin-bottom: 20px; }
  .dm-landing .hero h1 .line2 { color: var(--accent); }
  ...
  .hero-badge {
    ...
    background: var(--overlay-bg); border: 1px solid var(--border2);
  ...
  .ref-bar-wrap { height: 6px; background: var(--surface-3); border-radius: 100px; overflow: hidden; }
  ...
  .deep-card {
    margin-top: 16px; padding: 16px; background: var(--surface-1);
  ...
  .deep-bar-wrap { height: 4px; background: var(--surface-3); border-radius: 100px; margin-top: 8px; overflow: hidden; }
  ...
  .chip-cat { background: var(--chip-bg); border-color: rgba(255,255,255,.15); color: var(--text); backdrop-filter: blur(8px); }
  .chip-date { background: var(--chip-date-bg); border-color: rgba(255,255,255,.1); color: var(--muted); backdrop-filter: blur(8px); }
  ...
  .cm-flag {
    ...
    display: grid; place-items: center; background: var(--chip-date-bg); backdrop-filter: blur(4px);
  }
  ...
  .country-opt:hover { background: var(--surface-1); }
  ...
  .modal-close {
    ...
    width: 32px; height: 32px; border-radius: 8px; background: var(--surface-3);
  ...
  .cta-btns { display: flex; gap: 10px; flex-direction: column; flex-wrap: wrap; }
  .cta-btns .btn-primary,
  .cta-btns .btn-ghost { padding: 12px 18px; justify-content: center; }

  .roi-steps { display:grid; grid-template-columns:repeat(3,1fr); text-align:center; }
  .roi-step { padding:16px; border-right:1px solid var(--border); }
  .roi-step:last-child { border-right:none; }
  .roi-step-label { font-size:11px; font-weight:700; letter-spacing:.1em; text-transform:uppercase; color:var(--muted); margin-bottom:10px; }
  .roi-step-icon { width:44px; height:44px; border-radius:12px; background:rgba(0,200,122,.1); border:1px solid rgba(0,200,122,.2); display:grid; place-items:center; margin:0 auto 12px; }
  .roi-step-title { font-weight:700; font-size:13px; }
  .roi-step-sub { font-size:12px; color:var(--muted); margin-top:4px; }
  .contact-strip { display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px; margin-top:16px; }
  ...
  @media(max-width:1024px) {
    .hero-inner { grid-template-columns: 1fr; gap: 40px; padding: 60px 16px; }
    .dm-landing .hero h1 { font-size: clamp(2.4rem,6vw,3.8rem); }
    ...
    .roi-steps { grid-template-columns: repeat(2,1fr); }
    .roi-step { border-right:none; border-bottom:1px solid var(--border); }
    .roi-step:nth-child(2n+1) { border-right:1px solid var(--border); }
    .roi-step-wide { grid-column:1 / -1; border-right:none !important; }
  ...
  @media(max-width:640px) {
    ...
    .dm-landing nav { display: none; }
    .roi-steps { grid-template-columns: 1fr; }
    .roi-step, .roi-step:nth-child(2n+1), .roi-step-wide { border-right:none; }
    .roi-step:last-child { border-bottom:none; }
    ...
    <div class="card reveal" style="margin-top:24px;padding:24px 16px;">
      <div class="roi-steps">
        <div class="roi-step">
          ...
          <div class="roi-step-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg></div>
          <div class="roi-step-title">Регистрация</div>
          <div class="roi-step-sub">Создайте аккаунт</div>
        </div>
        <div class="roi-step">
          <div class="roi-step-label">Шаг 2</div>
          <div class="roi-step-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></div>
        ...
        <div class="roi-step roi-step-wide">
          ...
          <div class="roi-step-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg></div>
