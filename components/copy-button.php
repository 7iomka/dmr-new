...
function copyButton(array $props = []) {
  ...
  $defaultClass = "relative p-2 bg-white dark:bg-zinc-800 shadow-sm border border-zinc-200 dark:border-transparent hover:bg-zinc-50 dark:hover:bg-zinc-700 text-zinc-700 dark:text-white rounded-lg transition-all active:scale-95 shrink-0";
