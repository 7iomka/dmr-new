            ...
            <form method="post" class="auth-card">
              ...
              <div class="relative z-10 flex flex-col gap-2">
                ...
                <div class="auth-input-wrap">
                  <span class="auth-input-icon-left"><i data-lucide="mail" class="h-4 w-4"></i></span>
                  <input id="login-email" name="email" type="email" required placeholder="name@example.com" class="auth-input-with-icons pr-4">
                </div>
              </div>
