        ...
        <div class="max-w-7xl mx-auto space-y-6">
          ...
          <div class="flex flex-col items-start md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Отслеживайте свои успехи и
                управляйте рефералами</p>
            </div>
            <div
              class="flex items-center gap-3 px-4 py-2 bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-lg shadow-sm">
              ...
              <div class="flex flex-col h-full justify-between relative z-10">
                ...
                <div>
                  <div class="flex items-baseline gap-2">
                    <h2 class="text-3xl font-bold text-zinc-900 dark:text-white whitespace-nowrap">
                      1,250.00 $</h2>
                  </div>
