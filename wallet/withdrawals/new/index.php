          ...
          <div class="card">
            <div class="card-body space-y-6">
              ...
              <div class="flex flex-wrap justify-end gap-3">
                ...
                <button class="btn-primary inline-flex items-center justify-center gap-2 rounded-lg px-5 py-3 text-xs font-bold uppercase tracking-widest">Перейти к подтверждению</button>
              </div>
            </div>
          </div>
        </section>
