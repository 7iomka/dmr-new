      ...
      <main class="page-main">
        <section class="space-y-6">
          <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            <button class="btn-primary inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-xs font-bold uppercase tracking-widest" data-modal-open="withdraw-address-add">
          ...
          <div class="grid gap-4 lg:grid-cols-2">
            <article class="card-simple space-y-3">
              ...
              <div class="flex flex-wrap gap-2 pt-2">
                <button class="rounded-lg border border-zinc-200 dark:border-zinc-700 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-zinc-500" disabled>Сделать по умолчанию</button>
                <button class="rounded-lg border border-zinc-200 dark:border-zinc-700 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-red-500">Удалить</button>
              </div>
            </article>
            ...
            <article class="card-simple space-y-3">
              ...
              <div class="flex flex-wrap gap-2 pt-2">
                <button class="btn-primary rounded-lg px-3 py-2 text-[10px] font-bold uppercase tracking-widest" data-modal-open="withdraw-address-confirm">Подтвердить</button>
                <button class="rounded-lg border border-zinc-200 dark:border-zinc-700 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-zinc-500">Сделать по умолчанию</button>
                <button class="rounded-lg border border-zinc-200 dark:border-zinc-700 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-red-500">Удалить</button>
              </div>
            </article>
          </div>
  ...
  <div class="modal-box animate-in zoom-in-95 fade-in duration-300" role="dialog" aria-modal="true" aria-label="Добавить адрес для вывода">
    ...
    <div class="modal-body space-y-4">
      ...
      <div class="flex justify-end gap-3 pt-2">
        <button type="button" data-modal-close class="inline-flex items-center justify-center gap-2 rounded-lg border border-zinc-300 dark:border-zinc-700 px-4 py-2 text-xs font-bold uppercase tracking-widest text-zinc-900 dark:text-zinc-100">Отмена</button>
        <button type="button" class="btn-primary inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-xs font-bold uppercase tracking-widest">Добавить адрес</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal animate-in fade-in duration-300" data-modal="withdraw-address-confirm" data-modal-size="lg" aria-hidden="true">
  ...
  <div class="modal-box animate-in zoom-in-95 fade-in duration-300" role="dialog" aria-modal="true" aria-label="Подтвердить адрес для вывода">
    ...
    <div class="modal-body space-y-4">
      ...
      <div class="flex justify-end gap-3 pt-2">
        <button type="button" data-modal-close class="inline-flex items-center justify-center gap-2 rounded-lg border border-zinc-300 dark:border-zinc-700 px-4 py-2 text-xs font-bold uppercase tracking-widest text-zinc-900 dark:text-zinc-100">Отмена</button>
        <button type="button" class="btn-primary inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-xs font-bold uppercase tracking-widest" id="otpConfirmBtn">Подтвердить адрес</button>
      </div>
    </div>
  </div>
</div>
