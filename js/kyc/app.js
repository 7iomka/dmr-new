...
const dom = {
  ...
  cameraStatus: document.getElementById('faceStatusMessage'),
...
function setStatus(type, message) {
  ...
  dom.cameraStatus.className = 'c-verification-status';
  dom.cameraStatus.classList.add(`is-${type}`);
