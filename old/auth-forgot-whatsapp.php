          ...
          <section class="auth-shell">
            ...
            <form method="post" class="auth-card">
              ...
              <div class="relative z-10 flex flex-col gap-2">
                <label for="forgot-whatsapp" class="c-form-label">WhatsApp</label>
                <div class="c-form-control__input-wrap">
                  ...
                  <input id="forgot-whatsapp" name="whatsapp" type="text" required placeholder="+7..." class="auth-input-with-icons pr-4">
                </div>
              </div>
