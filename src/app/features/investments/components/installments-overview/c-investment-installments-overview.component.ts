                ...
                <tbody>
                  @for (installment of activeInstallments; track installment.id) {
                    <tr class="c-investment-installments-table__main-row">
                      ...
                      <td>
                        <p class="c-investment-installments-table__strong">{{ installment.totalAmount }}</p>
                        <p>{{ installment.months }}</p>
                        <p>
                          Платёж в месяц:
                          <span class="c-investment-installments-table__strong">{{ installment.monthlyPayment }}</span>
                        </p>
                        <p>
                          Зарезервировано:
                          <span class="c-investment-installments-table__strong">{{ installment.reservedShares }}</span>
                          долей
                        </p>
                      </td>
                      <td>
                      ...
                      <td>
                        <p class="c-investment-installments-table__pair">
                          ...
                          <span class="c-investment-installments-table__strong">{{ installment.remainingAmount }}</span>
                        </p>
                        <p>
                          Доли:
                ...
                <article class="c-investment-installments-mobile-card">
                  <div class="c-investment-installments-mobile-card__head">
                    ...
                    <div class="c-investment-installments-mobile-card__actions">
                      ...
                      <p-button ariaLabel="Настройки контракта" severity="secondary" size="small" variant="outlined">
                        <svg class="h-3.5 w-3.5" lucideSettings pButtonIcon></svg>
                      </p-button>
                    </div>
                  </div>
                  ...
                  <div class="c-investment-installments-mobile-card__stats">
                    ...
                    <div class="c-investment-installments-mobile-card__stat">
                      <p>Даты</p>
                      <p class="c-investment-installments-mobile-card__line">{{ installment.startDate }}</p>
                      <p class="font-bold" [class.text-amber-600]="installment.nextDateDanger">
                        {{ installment.nextDate }}
                      </p>
                    </div>
                    <div class="c-investment-installments-mobile-card__stat">
