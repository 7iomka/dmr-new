		...
		<div class="flex-1 flex flex-col min-w-0 h-screen relative pb-15 lg:pb-0">
			...
			<main class="flex-1 overflow-y-auto px-4 py-6 lg:p-10">
				<div class="max-w-7xl mx-auto space-y-6">
					<div>
						<h1 class="text-2xl md:text-3xl font-bold tracking-tight text-zinc-900 dark:text-white text-left">Кошелёк
						</h1>
										...
										<tbody class="divide-y divide-zinc-100 dark:divide-zinc-800/50 text-xs">
											<tr class="hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors">
												...
												<td class="card-body-inset-x py-5">
													<span
														class="px-2 py-0.5 bg-cyan-500/10 text-cyan-500 text-[9px] font-bold uppercase rounded">INTERNAL</span>
												</td>
											...
											<tr class="hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors">
												...
												<td class="card-body-inset-x py-5">
													<span
														class="px-2 py-0.5 bg-cyan-500/10 text-cyan-500 text-[9px] font-bold uppercase rounded">STRIPE</span>
												</td>
											...
											<tr class="hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors">
												...
												<td class="card-body-inset-x py-5">
													<span
														class="px-2 py-0.5 bg-cyan-500/10 text-cyan-500 text-[9px] font-bold uppercase rounded">MERCHANT_RU</span>
												</td>
												<td class="card-body-inset-x py-5 font-semibold">TEST</td>
												<td class="card-body-inset-x py-5">
													<span
														class="px-2 py-0.5 bg-red-500/10 text-red-500 text-[9px] font-bold uppercase rounded">FAILED</span>
												</td>
											...
											<tr class="hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors">
												...
												<td class="px-6 py-5">
													<span
														class="px-2 py-0.5 bg-cyan-500/10 text-cyan-500 text-[9px] font-bold uppercase rounded">BANK_TRANSFER</span>
												</td>
												...
												<div class="px-4 pb-4 pt-0">
													<div
														...
														<div class="pt-2 border-t border-zinc-200 dark:border-zinc-800/80">
															<p class="text-[10px] uppercase font-bold text-zinc-500 mb-1.5 tracking-wider">Детали
																оплаты:</p>
										...
										<tbody class="divide-y divide-zinc-100 dark:divide-zinc-800/50 text-xs">
											<tr class="hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors">
												...
												<td class="card-body-inset-x py-5 text-[10px] whitespace-normal break-words">
													Пополнение основного счета через шлюз Stripe. Зачислено автоматически по результатам успешной
													верификации транзакции.
												</td>
											...
											<tr class="hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors">
												<td class="card-body-inset-x py-5">
													<span
														class="px-2 py-1 bg-red-500/10 text-red-500 text-[9px] font-bold uppercase rounded tracking-wider">Дебет</span>
												</td>
												...
												<td class="card-body-inset-x py-5 text-[10px] whitespace-normal break-words">Комиссия за
													обслуживание счета и перевод средств.</td>
											...
											<tr class="hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors">
												...
												<td class="card-body-inset-x py-5 text-[10px] whitespace-normal break-words">Удержание средств
													до завершения проверки безопасности KYC Level 3.</td>
											...
											<tr class="hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-colors">
												...
												<td class="card-body-inset-x py-5 text-[10px] whitespace-normal break-words">Средства
													разблокированы после успешного подтверждения.</td>
												<td class="card-body-inset-x py-5 text-[10px] text-zinc-400 whitespace-nowrap">09.02.2026 15:40
												</td>
											</tr>
										</tbody>
									</table>
													...
													<div
														...
														<div class="flex justify-between items-center">
															<span class="text-[10px] uppercase font-bold text-zinc-500 tracking-wider">Тип
																ссылки:</span>
															<span
																class="text-[10px] font-mono font-bold text-zinc-800 dark:text-zinc-300">INTERNAL_TX</span>
														</div>
														<div class="flex justify-between items-center">
															<span class="text-[10px] uppercase font-bold text-zinc-500 tracking-wider">Баланс
																после:</span>
															<span class="text-[10px] font-bold text-zinc-800 dark:text-zinc-300">12,450,000.80
																$</span>
														</div>
														<div class="pt-2 border-t border-zinc-200 dark:border-zinc-800/80">
															<p class="text-[10px] uppercase font-bold text-zinc-500 mb-1.5 tracking-wider">Описание:
															</p>
															<p class="text-[11px] leading-relaxed text-zinc-600 dark:text-zinc-400">Пополнение
																основного счета через шлюз Stripe. Средства зачислены мгновенно.</p>
														</div>
													</div>
												</div>
											</div>
													...
													<div
														...
														<div class="flex justify-between items-center">
															<span class="text-[10px] uppercase font-bold text-zinc-500 tracking-wider">Тип
																ссылки:</span>
															<span
																class="text-[10px] font-mono font-bold text-zinc-800 dark:text-zinc-300">WITHDRAWAL</span>
														</div>
														<div class="flex justify-between items-center">
															<span class="text-[10px] uppercase font-bold text-zinc-500 tracking-wider">Баланс
																после:</span>
															<span class="text-[10px] font-bold text-zinc-800 dark:text-zinc-300">12,448,000.80
																$</span>
														</div>
														<div class="pt-2 border-t border-zinc-200 dark:border-zinc-800/80">
															<p class="text-[10px] uppercase font-bold text-zinc-500 mb-1.5 tracking-wider">Описание:
															</p>
															<p class="text-[11px] leading-relaxed text-zinc-600 dark:text-zinc-400">Вывод средств на
																внешний кошелек USDT (TRC-20).</p>
														</div>
													</div>
												</div>
											</div>
