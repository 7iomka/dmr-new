					...
					<div class="card-simple flex flex-col lg:flex-row gap-6">
						...
						<div class="relative z-10 flex-1">
							...
							<div class="grid grid-cols-2 sm:flex flex-wrap gap-3">
								...
								<a href="withdraw.php" class="flex items-center justify-center gap-2 px-6 py-3 bg-zinc-50 dark:bg-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-700 text-zinc-900 dark:text-white text-[11px] font-bold rounded-lg transition-all border border-zinc-200 dark:border-zinc-700 uppercase tracking-widest">
